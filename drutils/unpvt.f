      SUBROUTINE unpvt(IBUF,ILEN,IERR,IDTER,LNATER,MAXPAS,
...
C
      ...
      IF  (IC1.EQ.0) THEN
        MAXPAS = MAX_PASS
      ELSE
        MAXPAS = IAS2B(IBUF,IC1,NCH)
      ENDIF
      IF  (MAXPAS.EQ.-32768) THEN  !
        IERR = -103
        RETURN
      END IF  !
C
