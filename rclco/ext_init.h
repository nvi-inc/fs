/* Defines the macros EXTERN and INIT depending on the setting of MAIN. 
 ...
 * The macro MAIN should be defined in the .c file making the main
 * definition.
 *
 * In some cases the INIT macro cannot be used because the argument contains
 * commas. In this case we work around by checking MAIN directly:
