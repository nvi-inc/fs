...
enum cmd_codes { CMD_PING, CMD_STOP, CMD_PLAY, CMD_RECORD, CMD_REWIND,
                 ...
                 CMD_DELAY_SET, CMD_DELAY_READ, CMD_DELAYM_READ, CMD_ERRMES,
...
= {
   ...
   {"tapetype_read       -- Read the current tape type setting",
    "tapetype_read",
        CMD_TAPETYPE_READ},
   {"station_info_read   -- Read the station number, serial number, and nickname",
    "station_info_read",
        CMD_STATION_INFO_READ},
