...
*
      function id2as(value,ias,ifc,nchtot,ncfrac)

C     This function converts a double to ASCII format
C 
C 
C  INPUT: 
C 
      double precision value
C     VALUE - double value to be converted
cxx      dimension ias(1)
      integer*2 ias(1)
...
C  OUTPUT:
C 
C     ID2AS - number of characters used in formatting value 
C 
C 
C  SUBROUTINES: 
C 
