...
|tape transport 1 a|`r1` |`rec1`, `tape1`, `rc`\*, `tp`*
|tape transport 2 a|`r2` |`rec2`, `tape2`, `rc`\*, `tp`*
...
3+|*S2 modules*
|tape recorder 1 a|`r1` |`rec1`, `tape1`, `rc`\*, `tp`*
...
|formatter a|`fm` a|`form`
|tape recorder 1 (except heads) a|`r1` |`rec1`, `tape1`, `rc`\*, `tp`*
|tape recorder 1 (except heads) a|`r2` |`rec2`, `tape2`, `rc`\*, `tp`*
