...
Upgrading to <<with_64-bit.adoc#,10.0.0 with 64-bit>>.
...
to _10.0.0-beta2_.  Certain steps are also utilized for upgrading and
converting to a 64-bit system at the same time, as described in the
<<with_64-bit.adoc#,10.0.0 with 64-bit>> document.
