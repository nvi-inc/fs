...
_beta2_ pre-release. Like all _beta_ pre-releases, this version is not
...
.. In the <<beta2.adoc#\_copy_control_files,Copy control files>>
sub-step, as shown in the <<beta2.adoc#,beta2 update notes>> document, your _clpgm.ctl_ file may have been
...
.. In the <<beta2.adoc#\_update_equip_ctl,Update equip.ctl>>
sub-step, as shown in the <<beta2.adoc#,beta2 update notes>> document,
