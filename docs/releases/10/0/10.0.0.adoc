...
_scnch_ and not add any other _monit<x>_ programs. If they are used in
...
want to add other _monit<x>_ programs. If so, you
...
can of course change that to whatever you like. You can also
temporarily override the address in the _rdbemsg_ utility itself.
...
updating from the VGOS branch, versions _9.12.<x>_, and probably only
if you had a RDBE rack.
