...
scripts, _be_client_, _mcicn_, and _udceth0_, if you were using them,
with the more general _s_client_. You can find instances of these
commands, using, e.g., for _be_client_:
...
. <<Update .fvwm2rc>> file to prevent some new windows from getting
the focus.
