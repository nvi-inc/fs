...
VGOS branch differ only in the details of step
<<Update control files>>
and two sub-steps of <<Update .prc files>>. To upgrade from
FS9 to FS10 on a 32-bit system, please follow the steps below.
...
command described in the <<changes_10.0.0.adoc#lohooks,LO hooks>> item
of the <<changes_10.0.0.adoc#,Changes from FS9>> document.  This
...
scripts _be_client_ and _mcicn_ with the more general _s_client_. You
can find instances of these commands, using, e.g., for _be_client_:
