...
files did not exist, or did not have the correct permissions, the old
...
This utility was originally developed by Jason Soohoo (Haystack) as
_vgos-msg-gui_. It is an RDBE oriented version of the FS _msg_ utility
for sending operations emails. Originally it ran on a different
back-end computer. It was ported to the FS computer, expanded to
provide pointing data, and generalized to support more systems.
