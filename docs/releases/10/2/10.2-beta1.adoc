...
* Information about setting DBBC3 IF target levels to avoid gain
compression has been added. Setting them properly requires attention
due to the very wide (4 GHz) input bandpass of the DBBC3. See the
<<../1/dbbc3_ops.adoc#_if_target_levels,IF target levels>>
