...
= FS 10.2-beta2 Update Notes
Version 0.76 - September 2023
...
<<../../../misc/64-bit_conversion.adoc#_login_as_root,Login as root>>
through
...
<<../../../misc/64-bit_conversion.adoc#_login_as_prog,Login as prog>>
and
<<../../../misc/64-bit_conversion.adoc#_update_station_programs,Update
station programs>>.

. Skip all remaining steps. However, if your local station programs
only uses C, you can test whether it will compile with the
...
software>>, but this is not necessary.
...
.. Use steps: <<../1/10.1.0.adoc#_remove_temporary_fixes,Remove
temporary fixes>> and <<../1/10.1.0.adoc#_local_customizations,Local
customizations>>.
...
the changes for 64-bit referred to in the
<<Version 9.13.2 (or 9.12.10-9.12.13)>> sub-section of this appendix.
If your FSL11 system is 64-bit, those changes will now be needed.
