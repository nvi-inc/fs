...
no legacy calibration measurements have been made, `N cal` is shown in
...
When averaging is in use, the data cal also be _filtered_. Nine new
...
... Invalid data is shown with a cyan background.
