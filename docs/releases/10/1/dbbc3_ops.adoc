...
diode is not firing. You may also see some clipping and auto-resets if
you are using filtering and have significant RFI.
...
* `` on=0`` is seen -- the FS has continuous calibration set to
