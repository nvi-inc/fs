...
version as an update is much simpler than the update to _10.0.0_, see
the <<Upgrading from 10.0.0>> section below.
...
Notes>> document, then the <<beta2_to_10.1.0adoc#,FS 10.1.0-beta2 to
...
If you have already installed _10.1.0-beta2_, please refer to the
<<beta2_to_10.1.0adoc#,FS 10.1.0-beta2 to FS 10.1.0 Update
...
repository. If you use _git_ (either one of the first two methods
after this block; the third method does not use _git_) and need to
preserve your old repository as your working copy, please use the
directions within this *IMPORTANT* block instead to download the
update and change your default branch to `main`:
...
your browser, click on this link instead <<onoff,Improve onoff>>, open
...
the possibly incorrect formatting of the error message.
