...
* Up to 16 dual side-band BBCs and four IFs for Mark IV (_.skd_) schedule files.
...
* The existing _skedf.ctl_ options `DBBC_IF_TARGETS` and `DBBC_BBC_TARGET` for
DBBC2s, can also be used for DBBC3s.
