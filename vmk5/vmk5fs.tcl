#!/usr/bin/wish
# written by G. Maccaferri - CNR Institute of Radioastronomy (Bologna), Italy fot TCL/TK 8.0 (FS version)
#############################################################################
...
# compute the span time between measures
   ...
   set difft [expr ($atime-$orftime + 1)/1000000.];                                 # + 1 to avoid by zero division
   set orftime $atime
   ...
   set avmbs [format "%6.1f" [expr ($currb-$sb2) * 8 /(($atime-$stime+1)/1000000. * pow(2,20))]]
...
.mk5.f0.disk itemconfig used -fill green
    ...
    button $base.f0.update \
        -command scanlist -font {Helvetica 10 normal} -text {force an update} 
    label $base.f0.reply \
        -borderwidth 1 -font {Helvetica 10 normal} -relief groove \
        -textvariable line 
    label $base.f0.recg \
        -borderwidth 1 -font {Helvetica 10 normal} -justify left -text 24.73GB \
        -textvariable recg 
    label $base.f0.t3 \
        -borderwidth 1 -font {Helvetica 10 normal} -text recorded: 
    label $base.f0.t4 \
        -borderwidth 1 -font {Helvetica 10 normal} -text {total size(GByte):} 
    label $base.f0.t6 \
        -borderwidth 1 -font {Helvetica 10 normal} -text available: 
    label $base.f0.avag \
        -borderwidth 1 -font {Helvetica 10 normal} -justify left \
...
if { $lerr == 0 } {
    ...
    listbox $base.f0.scans \
        -background #ebebeb -font {Helvetica 10 normal} \
...
if {$sscan != ""} {
  .mk5.f0.disk itemconfig #$sscan -fill blue
    ...
    label $base.f0.t7 \
        -borderwidth 1 -font {Helvetica 10 normal} -text {scan list:} 
    button $base.f0.stop \
        \
        -command {if { $rec } {
  M5send "record =off"
    ...
    label $base.f0.t11 \
        -borderwidth 1 -font {Helvetica 10 normal} -text {Last MK5 reply:} 
    label $base.f0.t13 \
    ...
    button $base.f0.ferr \
        -background gray -font {Helvetica 10 normal} -text error 
    button $base.f0.ready \
        -font {Helvetica 10 normal} -text ready 
    entry $base.f0.totalsz \
        -font {Helvetica 10 normal} -textvariable totg 
...
set fs  [expr $totb * pow(2,30)/ 600]
    ...
    canvas $base.fra18.01 \
        ...
        -width 378 
    entry $base.fra18.02 \
        -font {Helvetica 10 normal} -textvariable destip 
    label $base.fra18.03 \
        -borderwidth 1 -font {Helvetica 10 normal} \
...
if { $lerr } { set trstat Refused! 
  ...
  set trstat Connected!
        ...
        -font {Helvetica 10 normal} -text {Disk to Net} 
...
set cpos 0
.mk5.fra18.01 delete all} \
        -font {Helvetica 10 normal} -text {In to Net} 
...
set ptrb 0
set refkey "$trtype?"} \
        -font {Helvetica 10 normal} -text GO! 
...
.mk5.fra18.go conf -bg gray
.mk5.fra18.end conf -bg gray} \
        -font {Helvetica 10 normal} -text End 
    label $base.fra18.trstat \
        -background #808080 -borderwidth 1 -font {Helvetica 10 normal} \
    ...
    canvas $base.fra18.cmbs \
        ...
        -width 378 
    label $base.fra18.l4 \
        -borderwidth 1 -font {Helvetica 10 normal} -text {Av. trate (Mb/s):} 
    label $base.fra18.mbs \
        -borderwidth 1 -font {Helvetica 10 normal} -relief groove -text 0 \
        -textvariable avmbs 
    label $base.fra18.l5 \
        -borderwidth 1 -font {Helvetica 10 normal} -text 1Gb/s 
    label $base.fra18.t6 \
        -borderwidth 1 -font {{MS Sans Serif} 16} -relief raised \
...
blue - aver.} 
    ...
    button $base.but18 \
        ...
        -font {Helvetica 10 normal} -text connect 
    label $base.lab19 \
        -borderwidth 1 -font {Helvetica 10 normal} -text host: 
    entry $base.ent20 \
        -font {Helvetica 10 normal} -textvariable host 
    entry $base.ent21 \
        -font {Helvetica 10 normal} -textvariable port 
    label $base.lab22 \
        -borderwidth 1 -font {Helvetica 10 normal} -text port: 
    ###################
    # SETTING GEOMETRY
    ###################
    place $base.f0 \
