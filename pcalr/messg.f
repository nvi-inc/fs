...
C     IF (.NOT.KFIELD) GOTO 100
      icn = icn+ib2as(ivc,lmessg,icn,ocp100000+2)
      icn = mcoma(lmessg,icn)
      icn = icn+ib2as(itrk,lmessg,icn,ocp100000+2)
      goto 110
...
110   icn = mcoma(lmessg,icn)
      ...
      icn = mcoma(lmessg,icn)
      icn = icn+ib2as(nblkpc,lmessg,icn,ocp100000+3)
...
C 
      ...
      icn = icn+ib2as(ivc2,lmessg,icn,ocp100000+2)
      icn = mcoma(lmessg,icn) 
      icn = icn+ib2as(itrkpc(itrk),lmessg,icn,ocp100000+2)
      goto 210
