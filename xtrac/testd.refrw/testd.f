...
C
      double precision delin
      real tempc,humi,pres
      double precision res1,res2, refrwf, refrw2f
c     
...
C 
      ...
      do iel=5,85,10
         ...
         do jaz=5,355,30
            ...
            humi=50
            pres=900.
            delin=latcor*DEG2RAD
               res1=refrwf(delin,tempc,humi,pres)*RAD2DEG
               res2=refrw2f(delin,tempc,humi,pres)*RAD2DEG
            latoff=res2-res1
            inp=inp+1
            igp=igp+1 
            coslt=cos(latcor*RPI/180.) 
