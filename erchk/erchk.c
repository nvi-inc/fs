...
""
TA   -1
TAC tacd.ctl control file not present.
""
TA   -2
TAC tacd.ctl control file is empty and/or has an error.
""
TA   -3
TAC Can't open the socket or someone else is using it.
""
TA   -4
TAC Can't connect to socket.
""
TA   -5
TAC Can't read from socket.
""
TA   -6
TAC Can't write to socket.
""
TE   -9
