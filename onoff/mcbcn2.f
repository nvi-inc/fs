      subroutine mcbcn2(dtpi1,dtpi2,ierr) 
      double precision dtpi1,dtpi2
      integer ierr
C 
C read total power from two vlba detectors
c
C        dtpi1, dtpi2 = returned total powers
C 
C  OUTPUT:
C 
...
C 
      ...
      logical kbreak
C 
      data lwho/2Hnf/,lwhat/2Hmc/,ntry/2/ 
C 
      iter=ntry
12    continue
      iter=iter-1
...
c
      call fc_mcbcn_v2(dtpi1,dtpi2,ip)
C
