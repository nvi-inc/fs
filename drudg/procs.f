...
! 2015Mar20 JMG.  Added ability to generate proc file from sked file for Mark6 recorders. 
!                 Removed old 'proc_sked_proc' call which did same thing in a different way!!. 
