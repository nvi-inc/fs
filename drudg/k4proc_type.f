...
9019    FORMAT(' Select type of K4 equipment for ',4a2/
     ...
     .       ' 5 - K4-2  rack + DFC1200 recorder'/ 
     .       ' 6 - K4-2  rack + Mk4 formatter + VLBA recorder'/ 
     .       ' 7 - K4-2  rack + Mk4 formatter + VLBA4 recorder'/ 
     .       ' 8 - VLBA  rack + DFC1100 recorder'/ 
     .       ' 9 - VLBA  rack + DFC2100 recorder'/ 
     .       '10 - Mk3/4 rack + DFC1100 recorder'/ 
     .       '11 - Mk3/4 rack + DFC2100 recorder'/ 
     .       ' 0 - QUIT '/' ? ',$)

	call gtrsp(ibuf,80,luusr,nch)
	ikin= ias2b(ibuf(1),1,1)
	IF (ikin.EQ.0) RETURN
        IF (ikin.LT.1.OR.ikin.GT.10) GOTO 1
      endif
      iktype = ikin
      return
      end
