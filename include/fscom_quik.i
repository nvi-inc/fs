...
c
     ...
     . KENTP_FS
      ...
      INTEGER*2 LAUXFM(6), LAXFP(2), LDEVFP, LDV1NF, LDV2NF,
     . LTPCHK(2), LTPNUM(4), LOPRID(6), QFILL(1)
     ...
     . KRDWO_FS, KWRWO_FS, KDOAUX_FS, KRPTP_FS, KMVTP_FS,
     . LAUXFM, LAXFP, LDEVFP, LDV1NF, LDV2NF,
