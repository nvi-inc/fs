...
C
      ...
      INTEGER*2 IBUF(50),JBUF(50),NAMCM(32),NAMF(10),LOGNA(10),LSKNA(32)
      INTEGER*2 LTAPEN(4), LSOURN(4), LSFT, LEFT, LSOUON(4)
      EQUIVALENCE (IBUF,IBC),(JBUF,JBC),(NAMCM,NAMCMC),(NAMF,NAMFC)
      EQUIVALENCE (LOGNA,LOGNC),(LSKNA,LSKNC)
C
      COMMON /LXCOM/
     .SMAX(5),SMIN(5),IDCB(2),JDCB(144),IDCBSK(2),IBUF,
     .JBUF,LCOMND(6,5),LSTRNG(6,5),LSTATN(4),LLOGX(5),LTYPE(5),
     .NCOMND(5),NPARM(5),NSTRNG(5),LSOUON(4),LSOURN(4),LTAPEN(4),
     .LOGNA,LSKNA,IBLEN,IEQ,IKEY,ILEN,ITE1,ITE2,ITL1,
     .ITL2,ITS1,ITS2,LUUSR,LUDSP,L6,NCHAR,NCMD,NLINES,
     ...
     .NAMCM,IL,ICMD,IT3,LSTEND,NSCALE(5),ITSK1,ITSK2,ITSKE1,ITSKE2,
     .SDELTA(5)
C
C
