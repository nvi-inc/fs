...
void flt2str(output,fvalue,width,deci)     /* floating print to string */
...
void dble2str(output,fvalue,width,deci)     /* floating print to string */
char *output;                              /* output string to append to */
...
void uns2str2(output,ivalue,width,zorb)  /* unsigned print to string */
char *output;                           /* output string to append to */
...
/* this function is intended to be a replacement for FORTRAN ib2as routine */
{
      ...
      sprintf(form,"%%%s%s%du",sign,zero,wide);  /* make format */
      sprintf(string,form,ivalue);                       /* do it */
